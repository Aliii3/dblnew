...
export const HOME_TEAM: HomeTeamMember[] = [
  ...
  { name: "Shrouk Moustafa", role: "Senior Graphic Designer - Team Leader", motif: "design", image: "/media/team/editorial/shrouk.webp", bio: "Shrouk leads the design language behind DBLSHOT work, shaping visuals that feel bold, polished, and commercially useful — iced coffee in hand, with a moodboard for pretty much everything. She connects brand clarity with scroll-stopping creative." },
